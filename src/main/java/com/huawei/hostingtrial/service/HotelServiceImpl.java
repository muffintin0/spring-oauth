...
import com.huawei.hostingtrial.domain.Review;
import com.huawei.hostingtrial.domain.ReviewDetails;
...
class HotelServiceImpl implements HotelService {
	...
	public Review getReview(Hotel hotel, int reviewNumber) {
		Assert.notNull(hotel, "Hotel must not be null");
		return this.reviewRepository.findByHotelAndReviewIndex(hotel, reviewNumber);
	}
